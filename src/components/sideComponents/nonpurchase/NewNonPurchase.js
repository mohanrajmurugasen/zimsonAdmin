...
import { nonpurchaseProduct } from "../../../redux/actions/action";
...
import NonPurchaseTable from "./NonPurchaseTable";
...
export default function NewNonPurchase() {
  ...
  const technology = useSelector(
    (state) => state.addTechnology.technology.nonpurchase
  );
  ...
  return (
    <div>
      <div className="top">
        ...
        <div>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">NonPurchase</Typography>
          </Breadcrumbs>
        </div>
      </div>
      <div className="entire">
        ...
        <NonPurchaseTable search={search} setvals={setvals} vals={vals} />
      </div>
    </div>
  );
}
