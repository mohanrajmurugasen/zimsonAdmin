...
export default function NewAppUser() {
  ...
  const technology = useSelector(
    (state) => state.addTechnology.technology.appUser
  );
  ...
  return (
    <div>
      <div className="top">
        ...
        <div>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">AppUser</Typography>
          </Breadcrumbs>
        </div>
      </div>
      <div className="entire">
          ...
          <div className="filter">
            <Paper component="form" className={classes.root}>
              <InputBase
                ...
                placeholder="Filter AppUser"
                inputProps={{ "aria-label": "Filter AppUser" }}
                value={search}
        ...
        <AppUserTable search={search} setvals={setvals} vals={vals} />
      </div>
      <div>
        <Modal
        ...
        >
          <Fade style={{ width: "40%" }} in={open}>
            <div className={classes.paper}>
              <h2 id="transition-modal-title">Add AppUser</h2>
              <div className="middle">
                ...
                <input
                  ...
                  placeholder="Enter AppUser Name"
                />
                  ...
                  style={{
                    backgroundColor:
                      name !== "" && name1 !== ""
                        ? "#0f5953"
                        : "rgb(15 89 83 / 72%)3",
                    color: name !== "" && name1 !== "" ? "white" : "#adb5bd",
                  }}
                  variant="contained"
                  disabled={name !== "" && name1 !== "" ? false : true}
                >
                  Add
                </Button>
              </div>
