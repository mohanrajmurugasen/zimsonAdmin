...
export default function NewUserGroup() {
  ...
  const technology = useSelector(
    (state) => state.addTechnology.technology.userGroup
  );
  ...
  return (
    <div>
      <div className="top">
        ...
        <div>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">UserGroup</Typography>
          </Breadcrumbs>
        </div>
      </div>
      <div className="entire">
        ...
        <UserGroupTable search={search} setvals={setvals} vals={vals} />
      </div>
      <div>
        <Modal
        ...
        >
          <Fade style={{ width: "40%" }} in={open}>
            <div className={classes.paper}>
              <h2 id="transition-modal-title">Add UserGroup</h2>
