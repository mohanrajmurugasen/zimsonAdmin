...
import MasProductLineTable from "./MasProductLineTable";
...
export default function NewMasProductLine() {
  ...
  return (
    <div>
      <div className="top">
        ...
        <div>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">ProductLine</Typography>
          </Breadcrumbs>
        </div>
      </div>
      <div className="entire">
        ...
        <MasProductLineTable search={search} setvals={setvals} vals={vals} />
      </div>
      <div>
        <Modal
