...
export default function NewAllergen() {
  const classes = useStyles();
  const [open, setOpen] = React.useState(false);
  const [name, setname] = React.useState("");
  const [vals, setvals] = useState(true);
  const technology = useSelector(
    (state) => state.addTechnology.technology.allergen
  );
  ...
  return (
    <div>
      <div className="top">
        ...
        <div>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">Allergen</Typography>
          </Breadcrumbs>
        </div>
      </div>
      <div className="entire">
          ...
          <div className="filter">
            <Paper component="form" className={classes.root}>
              <InputBase
                ...
                inputProps={{ "aria-label": "Filter Allergen" }}
                value={search}
        ...
        <AllergenTable search={search} setvals={setvals} vals={vals} />
      </div>
      <div>
        <Modal
        ...
        >
          <Fade style={{ width: "40%" }} in={open}>
            <div className={classes.paper}>
              <h2 id="transition-modal-title">Add Allergen</h2>
