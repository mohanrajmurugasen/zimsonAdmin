...
export default function FlavourCategoryTable({ search, setvals, vals }) {
  ...
  const handleClose2 = () => {
    authaxios.delete(`FlavourCategorys?id=${id}`).then((res) => {
      setOpen(false);
      setvals(!vals);
    });
  };
        ...
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">Flavour Category Name</TableCell>
          ...
          >
            <Fade style={{ width: "40%" }} in={open}>
              {modals === "delete" ? (
                ...
                <div className={classes.paper}>
                  <h2 id="transition-modal-title">Edit Flavour Category</h2>
