...
export default function NewLocation() {
  ...
  const technology = useSelector(
    (state) => state.addTechnology.technology.location
  );
  ...
  return (
    <div>
      ...
      <div className="entire">
          ...
          <div className="filter">
            <Paper component="form" className={classes.root}>
              <InputBase
                ...
                inputProps={{ "aria-label": "Filter Location" }}
                value={search}
        ...
        <LocationTable search={search} vals={vals} setvals={setvals} />
      </div>
      <div>
        <Modal
        ...
        >
          <Fade style={{ width: "40%" }} in={open}>
            <div className={classes.paper}>
              <h2 id="transition-modal-title">Add Location</h2>
